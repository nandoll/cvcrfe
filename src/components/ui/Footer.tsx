    ...
    <footer className="bg-gray-100 dark:bg-gray-900 py-8 mt-16">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-6 md:mb-0">
            ...
            <p className="mt-2 text-gray-600 dark:text-gray-400">
              {t("experience.title")} - {currentYear}
            </p>
          </div>
          ...
          <div className="mt-6 md:mt-0 flex gap-4">
            ...
            <a
              href={`mailto:${
                process.env.NEXT_PUBLIC_CONTACT_EMAIL || "fantezana@gmail.com"
              }`}
              className="text-gray-700 hover:text-indigo-600 transition dark:text-gray-300 dark:hover:text-indigo-400"
              aria-label="Email"
            >
        ...
        <div className="mt-8 text-center text-gray-600 dark:text-gray-400 text-sm">
          <p>
            &copy; {currentYear} Fernando Antezana.{" "}
            {t("footer.allRightsReserved")}
          </p>
          <p className="mt-2">
            {t("footer.builtWith")} <span className="text-red-500">❤</span>{" "}
            {t("footer.using")} Next.js, TypeScript, Tailwind CSS & NestJS
          </p>
        </div>
      </div>
    </footer>
